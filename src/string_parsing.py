...
class StringParsing:
    ...
    @staticmethod
    def longest_palindrome_seq_len(s: str) -> int:
        long_palin_len = 0
        letter_counts = {}
...
assert_string_parsing(StringParsing.longest_palindrome_seq_len, ["abccccdd"], 7)
assert_string_parsing(StringParsing.longest_palindrome_seq_len, ["a"], 1)
...
assert_string_parsing(StringParsing.longest_unique_char_substr, ["abcabcbb"], 3)
assert_string_parsing(StringParsing.longest_unique_char_substr, ["bbbbb"], 1)
assert_string_parsing(StringParsing.longest_unique_char_substr, ["pwwkew"], 3)
